/**
 * Walmart Process Section Component
 * 
...
import type { WalmartProcessSectionProps } from '@/types';

export default function WalmartProcessSection({
  title = "Our Process",
  subtitle = "A proven step-by-step approach to your success",
  steps,
  className = "",
}: WalmartProcessSectionProps) {
  return (
