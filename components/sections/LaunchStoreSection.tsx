/**
 * Launch Store Section Component
 * 
 * Displays "Launch Your Amazon Store" section with title, subtitle, CTA button, and Amazon logo visual.
 * Matches the "Launch Your TikTok Shop" section structure from homepage.
 * 
 * @component
 * @example
 * ```tsx
 ...
 * 
 * Features:
 * - Title with purple accent on "Amazon"
 * - Subtitle text
 * - CTA button
 * - Amazon logo visual elements
 * - Decorative background elements
 * - Purple gradient glows
 * - Contact form
 * 
 * @returns {JSX.Element} Launch Store section with CTA and Amazon logo
 */
'use client';
...
export default function LaunchStoreSection({
  ...
  return (
    <div className={`relative min-h-[500px] md:min-h-[600px] lg:min-h-[698.728px] w-full overflow-hidden ${className}`}>
      ...
      <div className="relative mx-auto max-w-[1440px] w-full px-4 sm:px-6 lg:px-8 min-h-[500px] md:min-h-[600px] lg:min-h-[698.728px]">
        ...
        <div className="hidden lg:block absolute h-[569.965px] left-[calc(50%-386.44px)] top-[67.88px] -translate-x-1/2 w-[73.76px] z-0">
          <OptimizedImage
            src="/images/icons/ellipse-7175.svg"
            alt=""
            width={74}
            height={570}
        ...
        <div className="hidden lg:flex absolute inset-[20.18%_16.58%_59.59%_73.5%] items-center justify-center z-0">
          <div className="flex-none rotate-[30deg] size-[103.474px]">
            <OptimizedImage
              src="/images/icons/engine-nine-ellipse.svg"
              alt=""
              width={103}
              height={103}
        ...
        <div className="absolute h-[40.233px] right-[342.24px] top-[192.13px] w-[41.071px] z-0 hidden lg:block">
          <OptimizedImage
            src="/images/amazon/logos/logo-13.svg"
            alt=""
            width={41}
            height={40}
        ...
        <div className="absolute h-[42.747px] right-[372.2px] top-[606.83px] w-[41.909px] z-0 hidden lg:block">
          <OptimizedImage
            src="/images/amazon/logos/logo-52.svg"
            alt=""
            width={42}
            height={43}
            className="object-contain w-full h-full"
        ...
        <div className="absolute right-[102.59px] size-[33.527px] top-[53.64px] z-0 hidden lg:block">
          <OptimizedImage
            src="/images/amazon/logos/logo-89.svg"
            alt=""
            width={34}
            height={34}
            className="object-contain w-full h-full"
        ...
        <div className="absolute h-[40.233px] left-[581.05px] top-[81.29px] w-[41.071px] z-0 hidden lg:block">
          <OptimizedImage
            src="/images/amazon/logos/logo-15.svg"
            alt=""
            width={41}
            height={40}
            className="object-contain w-full h-full"
        ...
        <div className="absolute left-[654.41px] size-[33.527px] top-[406.64px] z-0 hidden lg:block">
          <OptimizedImage
            src="/images/amazon/logos/logo-86.svg"
            alt=""
            width={34}
            height={34}
            className="object-contain w-full h-full"
        ...
        <div className="absolute left-[346.41px] size-[33.527px] top-[477.64px] z-0 hidden lg:block">
          <OptimizedImage
            src="/images/amazon/logos/frame.svg"
            alt=""
            width={34}
            height={34}
            className="object-contain w-full h-full"
        ...
        {/* Amazon logo main visual - large rotated - visible on all screens */}
        ...
        {/* Amazon logo - small rotated - visible on all screens */}
        ...
        <div className="relative z-10 flex flex-col lg:flex-row items-center lg:items-center justify-between gap-6 md:gap-8 lg:gap-12 pt-8 md:pt-12 lg:pt-0 pb-6 md:pb-8 lg:pb-0 min-h-[500px] md:min-h-[600px] lg:min-h-[698.728px]">
          ...
          <div className="flex flex-col items-center lg:items-start text-white w-full lg:w-auto text-center lg:text-left">
            ...
            >
              Launch Your <span className="text-[#e1c8ff]">Amazon</span>
              <br className="hidden sm:block" />
              <span className="sm:hidden"> </span>
              <span className="text-[#e1c8ff]">Store</span>
            </Heading>
