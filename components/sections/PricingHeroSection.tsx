 ...
 * 
 * Hero section for Pricing page matching homepage hero structure exactly.
 * Includes "Simple, Transparent Pricing" heading with purple accent, subtitle, marketplace logos, and CTA buttons.
 * 
 * @component
 */
...
export default function PricingHeroSection({
  ...
  subtitle = "Choose the perfect plan for your business. All packages include expert setup, optimization, and ongoing support.",
  className = "",
    ...
    <div className={`relative min-h-[500px] md:min-h-[600px] flex items-center justify-center overflow-visible px-4 md:px-0 w-full ${className}`}>
      ...
      <Container size="xl" className="relative z-10">
        <div className="flex flex-col items-center text-center gap-3 md:gap-6 pt-32 md:pt-44 lg:pt-48">
          ...
          >
            <span>Simple, </span>
            <span className="text-[#E1C8FF]">Transparent Pricing</span>
          </Heading>
