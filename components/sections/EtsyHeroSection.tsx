/**
 * Etsy Hero Section Component
 * 
 * Hero section for Etsy Optimization page matching Figma design exactly.
 * Includes "Etsy Shop Optimization" heading, subtitle, two CTA buttons, and decorative Etsy logo elements.
 * 
 * @component
 * @example
 * ```tsx
 ...
 * - Decorative Etsy logo elements positioned around hero
 * - Background decorative elements (ellipses, rectangles)
 * 
 * @returns {JSX.Element} Etsy Optimization hero section with heading, subtitle, and CTAs
 */
...
import type { EtsyHeroSectionProps } from '@/types';

export default function EtsyHeroSection({
  title = "Etsy Shop Optimization",
  subtitle = "Launch, optimize, and scale your Etsy business with our comprehensive suite of Etsy-specific services. From shop setup to SEO optimization, we handle everything.",
  primaryCtaText = "Get Started Today",
  primaryCtaHref = "/contact",
  secondaryCtaText = "View Success Stories",
  secondaryCtaHref = "/case-studies",
  className = "",
}: EtsyHeroSectionProps) {
  return (
    <div className={`relative min-h-[500px] md:min-h-[600px] flex items-center justify-center overflow-visible px-4 md:px-0 w-full ${className}`}>
      ...
      {/* Etsy logo decorative elements - Hidden on mobile */}
      <div className="hidden lg:flex absolute h-[427.418px] items-center justify-center left-[-129px] top-[683px] w-[427.05px] rotate-[34.046deg]">
        <OptimizedImage
          src="/images/etsy/hero/etsy-hero.png"
          alt=""
          width={308}
          height={308}
