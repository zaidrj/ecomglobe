...
export default function WalmartCTASection() {
  const benefits = [
  ...
  return (
    <Container size="lg" className="pt-4 md:pt-6 lg:pt-8 pb-12 md:pb-16 lg:pb-20 relative z-10">
      <div className="flex flex-col items-center text-center gap-4 md:gap-6 lg:gap-8 max-w-[877px] mx-auto px-4 md:px-6">
        {/* Title */}
        ...
        <div className="flex flex-col gap-2 md:gap-3">
          {benefits.map((benefit, index) => (
            <Text key={index} variant="body" color="muted" className="flex items-center justify-center gap-2 text-[14px] sm:text-[16px] md:text-[20px] lg:text-[22px]">
              <span className="text-[#AB78E9] text-[20px] md:text-[22px] lg:text-[24px]">✓</span>
              <span>{benefit}</span>
            </Text>
          ))}
        </div>
        ...
        <div className="mt-4 md:mt-8 w-full sm:w-auto">
          <Link
            href="/contact"
            className="border-[#7300ff] border-[0.986px] border-solid px-4 md:px-[19.712px] py-3 md:py-[14.784px] rounded-full md:rounded-[19.712px] shadow-[0px_20.698px_38.735px_-48px_rgba(132,0,255,0.33)] font-primary font-bold leading-[1.3] not-italic text-[14px] md:text-[18px] text-center text-white uppercase w-full sm:w-auto transition-all duration-200 hover:shadow-[0px_0px_30px_5px_rgba(132,0,255,0.6),0px_20.698px_38.735px_-48px_rgba(132,0,255,0.5)] active:opacity-80 inline-block cursor-pointer relative z-10"
            style={{
