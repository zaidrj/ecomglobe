/**
 * TikTok Stats Section Component
 * 
 ...
 * @example
 * ```tsx
 * <TikTokStatsSection stats={statsData} />
 * ```
 * 
 * Features:
...
import type { TikTokStatsSectionProps } from '@/types';

export default function TikTokStatsSection({
  stats,
  className = "",
}: TikTokStatsSectionProps) {
  ...
  return (
    <div className={`relative w-full max-w-[1192px] mx-auto min-h-[300px] sm:min-h-[400px] md:min-h-[500px] lg:min-h-[600px] py-8 ${className}`}>
      ...
      <div className="hidden lg:block absolute inset-0 overflow-hidden pointer-events-none rounded-tl-[10px] rounded-tr-[10px]">
        <OptimizedImage
          src="/images/tiktok/hero/frame-62.png"
          alt=""
          width={1192}
          height={504}
