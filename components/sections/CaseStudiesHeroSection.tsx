/**
 * Case Studies Hero Section Component
 * 
 * Hero section for Case Studies page matching homepage hero structure exactly.
 * Includes "Success Stories" heading with purple accent, subtitle, marketplace logos, and CTA buttons.
 * 
 * @component
 */
...
export default function CaseStudiesHeroSection({
  ...
  subtitle = "Real results from real businesses. See how we've helped ecommerce brands launch, scale, and dominate their marketplaces.",
  className = "",
    ...
    <div className={`relative min-h-[500px] md:min-h-[600px] flex items-center justify-center overflow-visible px-4 md:px-0 w-full ${className}`}>
      ...
      <Container size="xl" className="relative z-10">
        <div className="flex flex-col items-center text-center gap-3 md:gap-6 pt-32 md:pt-44 lg:pt-48">
          ...
          >
            <span>Success </span>
            <span className="text-[#E1C8FF]">Stories</span>
          </Heading>
