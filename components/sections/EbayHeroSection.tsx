/**
 * Ebay Hero Section Component
 * 
 * Hero section for Ebay Development page matching Figma design exactly.
 * Includes "eBay Store Management" heading, subtitle, two CTA buttons, and decorative Ebay logo elements.
 * 
 * @component
 * @example
 * ```tsx
 ...
 * - Decorative Ebay logo elements positioned around hero
 * - Background decorative elements (ellipses, rectangles)
 * 
 * @returns {JSX.Element} Ebay Development hero section with heading, subtitle, and CTAs
 */
...
import type { EbayHeroSectionProps } from '@/types';

export default function EbayHeroSection({
  title = "eBay Store Management",
  subtitle = "Launch, optimize, and scale your eBay business with our comprehensive suite of eBay-specific services. From store setup to listing optimization, we handle everything.",
  primaryCtaText = "Get Started Today",
  primaryCtaHref = "/contact",
  secondaryCtaText = "View Success Stories",
  secondaryCtaHref = "/case-studies",
  className = "",
}: EbayHeroSectionProps) {
  return (
    <div className={`relative min-h-[500px] md:min-h-[600px] flex items-center justify-center overflow-visible px-4 md:px-0 w-full ${className}`}>
      ...
      {/* Ebay logo decorative elements - Hidden on mobile */}
      <div className="hidden lg:flex absolute h-[427.418px] items-center justify-center left-[-129px] top-[683px] w-[427.05px] rotate-[34.046deg]">
        <OptimizedImage
          src="/images/ebay/hero/ebay-hero.png"
          alt=""
          width={308}
          height={308}
