/**
 * TikTok Launch Section Component
 * 
 * Displays "Launch Your TikTok Store" section with title, subtitle, CTA button, and TikTok logo visual.
 * 
 * @component
 * @example
 * ```tsx
 ...
 * 
 * Features:
 * - Title with purple accent on "TikTok"
 * - Subtitle text
 * - CTA button
 * - TikTok logo visual elements
 * - Decorative background elements
 * 
 * @returns {JSX.Element} Launch Store section with CTA and TikTok logo
 */

import { Heading, Text } from '@/components/ui/Typography';
import Button from '@/components/ui/Button';
import OptimizedImage from '@/components/ui/OptimizedImage';
import type { TikTokLaunchSectionProps } from '@/types';

export default function TikTokLaunchSection({
  title = "Launch Your TikTok Shop Store",
    ...
    <div className={`absolute h-[698.728px] left-[-6px] top-[2574px] w-[1425.349px] ${className}`}>
      ...
      <div className="absolute bottom-[58.21%] capitalize left-[calc(50%-583.67px)] text-[48px] text-white top-[24.62%] w-[610px]">
        ...
        >
          ...
          <span className="text-[#e1c8ff]">TikTok Shop </span>
        </Heading>
        <Heading
          as="h2"
          variant="h1"
