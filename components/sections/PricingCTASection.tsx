 ...
 * 
 * CTA section for Pricing page matching homepage CTA exactly.
 * Displays title, benefits, and CTA button.
 * 
 * @component
 */
...
export default function PricingCTASection({
  title = "Free Ecommerce Platform Audit",
  description = "Join 100+ successful brands who chose EcommGlobe. Start with a free consultation to find the perfect plan for your business.",
  ...
  return (
    <Container size="lg" className={`pt-4 md:pt-6 lg:pt-8 pb-12 md:pb-16 lg:pb-20 relative z-10 px-4 md:px-6 ${className}`}>
