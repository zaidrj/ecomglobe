/**
 * Shopify What's Included Section Component
 * 
 * Displays "What's Included" section with title, subtitle, and bulleted list of 8 services.
 * 
 * @component
 * @example
 * ```tsx
 * <ShopifyWhatsIncludedSection services={servicesData} />
 * ```
 * 
 * Features:
 * - Title with purple accent on "Included"
 * - Subtitle text
 * - Bulleted list of 8 Shopify services
...
import type { ShopifyWhatsIncludedSectionProps } from '@/types';

export default function ShopifyWhatsIncludedSection({
  title = "What's Included",
  subtitle = "Comprehensive services to ensure your success",
  services,
  className = "",
}: ShopifyWhatsIncludedSectionProps) {
  return (
    <div className={`absolute h-[562px] left-[120px] top-[1220px] w-[1201px] ${className}`}>
      ...
      <div className="absolute left-0 rounded-[24px] size-[562px] top-0">
        <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[24px]">
          <OptimizedImage
            src="/images/shopify/hero/rectangle-4600.png"
