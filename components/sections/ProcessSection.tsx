 ...
 * 
 * "Our Process" section matching Figma design exactly.
 * Shows 5-step process with icons, titles, descriptions, and arrow connectors.
 * 
 * @component
 * @example
 * ```tsx
 ...
 * - 5 process steps in horizontal flow (desktop) or wrapped (mobile)
 * - Each step includes: icon, title (uppercase), description
...
import type { ProcessSectionProps, LegacyProcessStep } from '@/types';
      ...
      <Container size="xl" className="relative z-10">
        <div className="flex flex-col items-center text-center gap-8 md:gap-12 lg:gap-[68px]">
          ...
          <div className="flex flex-col items-center gap-4 md:gap-8 lg:gap-[68px]">
            ...
            >
              A proven 5-step framework to launch and scale your ecommerce business
            </Text>
          </div>
          ...
          <div className="w-full max-w-[1180px]">
            ...
            <div className="flex flex-wrap md:flex-nowrap items-center justify-center gap-6 sm:gap-8 md:gap-[50px_40px] mb-6 sm:mb-8 md:mb-0">
              {sortedSteps.slice(0, 3).map((step: LegacyProcessStep, index: number) => (
            ...
            <div className="flex flex-wrap md:flex-nowrap items-center justify-center gap-6 sm:gap-8 md:gap-[50px_40px] mt-6 sm:mt-8 md:mt-8">
              {sortedSteps.slice(3, 5).map((step: LegacyProcessStep, index: number) => (
                <div key={step.id} className="flex items-center">
                  {/* Process Step */}
                  <div className="flex flex-col gap-2 md:gap-[10px] items-center w-[140px] sm:w-[180px] md:w-[284px] text-center">
                    {/* Step Icon */}
