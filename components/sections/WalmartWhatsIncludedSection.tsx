/**
 * Walmart What's Included Section Component
 * 
 ...
 * @example
 * ```tsx
 * <WalmartWhatsIncludedSection services={servicesData} />
 * ```
 * 
 * Features:
 * - Title with purple accent on "Included"
 * - Subtitle text
 * - Bulleted list of 8 Walmart services
...
import type { WalmartWhatsIncludedSectionProps } from '@/types';

export default function WalmartWhatsIncludedSection({
  title = "What's Included",
  subtitle = "Comprehensive services to ensure your success",
  services,
  className = "",
}: WalmartWhatsIncludedSectionProps) {
  return (
    <div className={`absolute h-[562px] left-[120px] top-[1220px] w-[1201px] ${className}`}>
      ...
      <div className="absolute left-0 rounded-[24px] size-[562px] top-0">
        <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[24px]">
          <OptimizedImage
            src="/images/walmart/hero/rectangle-4600.png"
