/**
 * Amazon Hero Section Component
 * 
 * Hero section for Amazon Marketing page matching Figma design exactly.
 * Includes "Amazon Marketing & Management" heading, subtitle, two CTA buttons, and decorative Amazon logo elements.
 * 
 * @component
 * @example
 * ```tsx
 ...
 * - Decorative Amazon logo elements positioned around hero
 * - Background decorative elements (ellipses, rectangles)
 * 
 * @returns {JSX.Element} Amazon Marketing hero section with heading, subtitle, and CTAs
 */
...
import type { AmazonHeroSectionProps } from '@/types';

export default function AmazonHeroSection({
  title = "Amazon Marketing & Management",
  subtitle = "Launch, optimize, and scale your Amazon business with our comprehensive suite of Amazon-specific services. From FBA setup to PPC management, we handle everything.",
  primaryCtaText = "Get Started Today",
  primaryCtaHref = "/contact",
  secondaryCtaText = "View Success Stories",
  secondaryCtaHref = "/case-studies",
  className = "",
}: AmazonHeroSectionProps) {
  return (
    <div className={`relative min-h-[500px] md:min-h-[600px] flex items-center justify-center overflow-visible px-4 md:px-0 w-full ${className}`}>
      ...
      {/* Amazon logo decorative elements - Hidden on mobile */}
      <div className="hidden lg:flex absolute h-[427.418px] items-center justify-center left-[-129px] top-[683px] w-[427.05px] rotate-[34.046deg]">
        <OptimizedImage
          src="/images/amazon/hero/amazon-3.png"
          alt=""
          width={308}
          height={308}
