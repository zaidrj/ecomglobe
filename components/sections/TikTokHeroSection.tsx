 ...
 * 
 * Hero section for TikTok Development page matching Figma design exactly.
 * Includes "TikTok Shop Setup & Management" heading, subtitle, two CTA buttons, and decorative TikTok logo elements.
 * 
 * @component
 * @example
 * ```tsx
 ...
 * - Decorative TikTok logo elements positioned around hero
 * - Background decorative elements (ellipses, rectangles)
 * 
 * @returns {JSX.Element} TikTok Development hero section with heading, subtitle, and CTAs
 */
...
import type { TikTokHeroSectionProps } from '@/types';

export default function TikTokHeroSection({
  title = "TikTok Shop Setup & Management",
  subtitle = "Launch, optimize, and scale your TikTok Shop business with our comprehensive suite of TikTok-specific services. From account setup to creator partnerships, we handle everything.",
  primaryCtaText = "Get Started Today",
  primaryCtaHref = "/contact",
  secondaryCtaText = "View Success Stories",
  secondaryCtaHref = "/case-studies",
  className = "",
}: TikTokHeroSectionProps) {
  return (
    <div className={`relative min-h-[500px] md:min-h-[600px] flex items-center justify-center overflow-visible px-4 md:px-0 w-full ${className}`}>
      ...
      {/* TikTok logo decorative elements - Hidden on mobile */}
      <div className="hidden lg:flex absolute h-[427.418px] items-center justify-center left-[-129px] top-[683px] w-[427.05px] rotate-[34.046deg]">
        <OptimizedImage
          src="/images/tiktok/hero/tiktok-hero.png"
          alt=""
          width={308}
          height={308}
