/**
 * Case Studies Stats Section Component
 * 
 * Stats section for Case Studies page matching homepage StatsSection exactly.
 * Displays stats with dividers between them.
 * 
 * @component
 */
...
interface CaseStudiesStatsSectionProps {
  stats: StatItem[];
  className?: string;
}
      ...
      <Container size="lg" className="pt-0 pb-2 md:pb-4 lg:pb-6 px-4 md:px-6 relative z-10">
        <div className="grid grid-cols-2 lg:flex items-center gap-3 sm:gap-4 md:gap-8 lg:gap-[57px] justify-center">
          {stats.map((stat, index) => (
            <div key={stat.label} className="flex flex-col lg:flex-row items-center gap-2 lg:gap-[57px]">
