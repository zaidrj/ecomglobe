 ...
 * 
 * Hero section for Contact page matching homepage hero structure exactly.
 * Includes "Let's Get Started" heading with purple accent, subtitle, marketplace logos, and CTA buttons.
 * 
 * @component
 */
...
export default function ContactHeroSection({
  ...
  subtitle = "Ready to scale your ecommerce business? Fill out the form below and we'll get back to you within 24 hours with a custom growth plan.",
  className = "",
    ...
    <div className={`relative min-h-[500px] md:min-h-[600px] flex items-center justify-center overflow-visible px-4 md:px-0 w-full ${className}`}>
      ...
      <Container size="xl" className="relative z-10">
        <div className="flex flex-col items-center text-center gap-3 md:gap-6 pt-32 md:pt-44 lg:pt-48">
          ...
          >
            <span>Let's </span>
            <span className="text-[#E1C8FF]">Get Started</span>
          </Heading>
