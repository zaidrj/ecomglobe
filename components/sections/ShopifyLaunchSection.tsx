/**
 * Shopify Launch Section Component
 * 
 * Displays "Launch Your Shopify Store" section with title, subtitle, CTA button, and Shopify logo visual.
 * 
 * @component
 * @example
 * ```tsx
 ...
 * 
 * Features:
 * - Title with purple accent on "Shopify"
 * - Subtitle text
 * - CTA button
 * - Shopify logo visual elements
 * - Decorative background elements
 * 
 * @returns {JSX.Element} Launch Store section with CTA and Shopify logo
 */

import { Heading, Text } from '@/components/ui/Typography';
import Button from '@/components/ui/Button';
import OptimizedImage from '@/components/ui/OptimizedImage';
import type { ShopifyLaunchSectionProps } from '@/types';

export default function ShopifyLaunchSection({
  ...
  return (
    <div className={`absolute h-[698.728px] left-[-6px] top-[2574px] w-[1425.349px] ${className}`}>
      ...
      <div className="absolute h-[569.965px] left-[calc(50%-386.44px)] top-[67.88px] -translate-x-1/2 w-[73.76px]">
        <OptimizedImage
          src="/images/shopify/decorative/ellipse-7175.svg"
          alt=""
          width={74}
          height={570}
      ...
      <div className="absolute flex inset-[20.18%_16.58%_59.59%_73.5%] items-center justify-center">
        <div className="flex-none rotate-[30deg] size-[103.474px]">
          <OptimizedImage
            src="/images/shopify/decorative/engine-nine-ellipse.svg"
            alt=""
            width={103}
            height={103}
      ...
      <div className="absolute h-[40.233px] left-[1097.76px] top-[192.13px] w-[41.071px]">
        <OptimizedImage
          src="/images/shopify/logos/logo-13.svg"
          alt=""
          width={41}
          height={40}
      ...
      <div className="absolute h-[42.747px] left-[1067.8px] top-[606.83px] w-[41.909px]">
        <OptimizedImage
          src="/images/shopify/logos/logo-52.svg"
          alt=""
          width={42}
          height={43}
          className="object-contain"
      ...
      <div className="absolute left-[1337.41px] size-[33.527px] top-[53.64px]">
        <OptimizedImage
          src="/images/shopify/logos/logo-89.svg"
          alt=""
          width={34}
          height={34}
          className="object-contain"
      ...
      <div className="absolute h-[40.233px] left-[581.05px] top-[81.29px] w-[41.071px]">
        <OptimizedImage
          src="/images/shopify/logos/logo-15.svg"
          alt=""
          width={41}
          height={40}
          className="object-contain"
      ...
      <div className="absolute left-[654.41px] size-[33.527px] top-[406.64px]">
        <OptimizedImage
          src="/images/shopify/logos/logo-86.svg"
          alt=""
          width={34}
          height={34}
          className="object-contain"
      ...
      <div className="absolute left-[346.41px] size-[33.527px] top-[477.64px]">
        <OptimizedImage
          src="/images/shopify/logos/frame.svg"
          alt=""
          width={34}
          height={34}
          className="object-contain"
      ...
      <div className="absolute bottom-[58.21%] capitalize left-[calc(50%-583.67px)] text-[48px] text-white top-[24.62%] w-[610px]">
        ...
        >
          ...
          <span className="text-[#e1c8ff]">Shopify </span>
        </Heading>
        <Heading
          as="h2"
          variant="h1"
