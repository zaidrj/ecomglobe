/**
 * TikTok Contact Form Section Component
 * 
...
import type { TikTokContactFormSectionProps } from '@/types';

export default function TikTokContactFormSection({
  title = "Get Started Today",
  introText = "Fill out the form below and we'll get back to you within 24 hours",
  onSubmit,
  className = "",
}: TikTokContactFormSectionProps) {
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4 lg:gap-[20px] w-full lg:w-[510px]">
        ...
        >
          ...
          <div className="relative shrink-0 size-[16px]">
            <OptimizedImage
              src="/images/tiktok/icons/up-right-arrow-11.svg"
              alt=""
              width={16}
              height={16}
