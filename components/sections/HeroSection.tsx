    ...
    <div className="relative min-h-[500px] md:min-h-[600px] flex items-center justify-center overflow-visible px-4 md:px-0 w-full">
      ...
      <Container size="xl" className="relative z-10">
        <div className="flex flex-col items-center text-center gap-3 md:gap-6 pt-32 md:pt-44 lg:pt-48">
          ...
          >
            <span>Scale Your Brand Across </span>
            <span className="text-[#E1C8FF]">Every Marketplace</span>
          </Heading>
          ...
          <div className="relative w-full max-w-[1200px] mt-1 md:mt-4 overflow-visible">
            ...
            >
              We launch, optimize, and automate your stores on Amazon, Shopify, Etsy, Walmart, eBay & TikTok Shop—so you can focus on growth, not tech.
            </Text>
          </div>
