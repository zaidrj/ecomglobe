/**
 * Download Walmart Marketplace Page Images Script
 * Downloads all images from Figma MCP localhost URLs to the public/images/walmart directory
 */
...
// Image URLs extracted from Figma MCP for Walmart Marketplace page (node-id=101-3588)
const images = {
  hero: [
    { url: 'http://localhost:3845/assets/1a8d064a6087e40cb4d08a80bb8c74b1911a8e47.png', name: 'artboard1-copy-ecomm-globe-1.png' },
    { url: 'http://localhost:3845/assets/5c7a376df68c9d7155a31fb2f3dddedfd462e44e.png', name: 'walmart-hero.png' },
    { url: 'http://localhost:3845/assets/f40e7da61511ae2fc77716d0215098e0a8d19fe1.png', name: 'rectangle-4600.png' },
    { url: 'http://localhost:3845/assets/30ae844a5d090601504688a02efa856e7ce85f80.png', name: 'frame-62.png' },
  ...
  process: [
    { url: 'http://localhost:3845/assets/0e404041cfe05bfb90c51fe009ffd42002f2fa8c.svg', name: 'group-account-creation.svg' }, // Account Creation
    { url: 'http://localhost:3845/assets/8644516156273c0df68bfc0370dda176874c33dc.svg', name: 'vector-catalog-upload.svg' }, // Catalog Upload
    { url: 'http://localhost:3845/assets/e50ea25809e257b2a57c7b58ff808c9eda10e9ef.svg', name: 'group-content-enhancement.svg' }, // Content Enhancement
    { url: 'http://localhost:3845/assets/8b68b03cf6bc9454fdd5d2f946b8d10250d59a1f.svg', name: 'vector-advertising-launch.svg' }, // Advertising Launch
    { url: 'http://localhost:3845/assets/8d17acd078a0493909b1752837f86071716c2dfb.svg', name: 'vector-growth-management.svg' }, // Growth Management
  ],
  logos: [
...
async function downloadAllImages() {
  const baseDir = path.join(__dirname, '..', 'public', 'images', 'walmart');
