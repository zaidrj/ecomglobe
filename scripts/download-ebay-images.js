/**
 * Download eBay Management Page Images Script
 * Downloads all images from Figma MCP localhost URLs to the public/images/ebay directory
 */
...
// Image URLs extracted from Figma MCP for eBay Management page (node-id=101-3886)
const images = {
  hero: [
    { url: 'http://localhost:3845/assets/1a8d064a6087e40cb4d08a80bb8c74b1911a8e47.png', name: 'artboard1-copy-ecomm-globe-1.png' },
    { url: 'http://localhost:3845/assets/72ba4e0194bfcf4341a94b65abd4c18614ff5f6b.png', name: 'ebay-hero.png' },
    { url: 'http://localhost:3845/assets/6772f74098f61537ddf3e5736a32bbefb23c4d6b.png', name: 'rectangle-4600.png' },
    { url: 'http://localhost:3845/assets/1b4b3e9295f73c35715de97b1aef396bb017b052.png', name: 'frame-62.png' },
  ...
  process: [
    { url: 'http://localhost:3845/assets/7299023c89eacece7bcf6ce9cb4a2dbc311d636f.svg', name: 'vector-store-setup.svg' }, // Store Setup
    { url: 'http://localhost:3845/assets/490dbcaf7ac159181317dd280c1e6717e18c1a73.svg', name: 'group-listing-creation.svg' }, // Listing Creation
    { url: 'http://localhost:3845/assets/74b24828f173ed4e695ec9db3add13a93673828b.svg', name: 'vector-stroke-automation.svg' }, // Automation Setup
    { url: 'http://localhost:3845/assets/8b68b03cf6bc9454fdd5d2f946b8d10250d59a1f.svg', name: 'vector-marketing-launch.svg' }, // Marketing Launch
...
async function downloadAllImages() {
  const baseDir = path.join(__dirname, '..', 'public', 'images', 'ebay');
