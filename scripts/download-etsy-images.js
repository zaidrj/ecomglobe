/**
 * Download Etsy Optimization Page Images Script
 * Downloads all images from Figma MCP localhost URLs to the public/images/etsy directory
 */
...
// Image URLs extracted from Figma MCP for Etsy Optimization page (node-id=101-3290)
const images = {
  hero: [
    { url: 'http://localhost:3845/assets/1a8d064a6087e40cb4d08a80bb8c74b1911a8e47.png', name: 'artboard1-copy-ecomm-globe-1.png' },
    { url: 'http://localhost:3845/assets/92bd88e9dc6f09995afd76859f9522594b0a0f0a.png', name: 'etsy-hero.png' },
    { url: 'http://localhost:3845/assets/3c7e0be15df3b25f74c5379023096039a7a0cb73.png', name: 'rectangle-4600.png' },
    { url: 'http://localhost:3845/assets/9f9fe77569c8c95e63c910f007b1358c59455583.png', name: 'etsy-hero-2.png' },
    { url: 'http://localhost:3845/assets/561186d123148c1c5b2e45107eabf4e87d2a342e.png', name: 'frame-62.png' },
  ...
  process: [
    { url: 'http://localhost:3845/assets/011270b31b42693c0aa26bf42e8084a3e04a01a3.svg', name: 'group-shop-audit.svg' }, // Shop Audit
    { url: 'http://localhost:3845/assets/3d3b68b7a2038fe07314ab52a20b7a7a702ef2bc.svg', name: 'group-seo-research.svg' }, // SEO Research
    { url: 'http://localhost:3845/assets/e50ea25809e257b2a57c7b58ff808c9eda10e9ef.svg', name: 'group-listing-optimization.svg' }, // Listing Optimization
    { url: 'http://localhost:3845/assets/e49956635b8f1d6ff6e572756f004336f2ff929a.svg', name: 'vector-visual-enhancement.svg' }, // Visual Enhancement
    { url: 'http://localhost:3845/assets/fc24a37c4358add4d744dc7d431b0216f4e59f95.svg', name: 'vector-marketing-setup.svg' }, // Marketing Setup
  ],
  logos: [
...
async function downloadAllImages() {
  const baseDir = path.join(__dirname, '..', 'public', 'images', 'etsy');
