/**
 * Download Amazon Marketing Page Images Script
 * Downloads all images from Figma MCP localhost URLs to the public/images/amazon directory
 */
...
// Image URLs extracted from Figma MCP for Amazon Marketing page
const images = {
  hero: [
    { url: 'http://localhost:3845/assets/1a8d064a6087e40cb4d08a80bb8c74b1911a8e47.png', name: 'artboard1-copy-ecomm-globe-1.png' },
    { url: 'http://localhost:3845/assets/fcf7867b1c7608da0888760c68e7e0416c391761.png', name: 'amazon-3.png' },
    { url: 'http://localhost:3845/assets/7fa0d81bbe9600183b81f44b6c12ff8634d291d7.png', name: 'frame-62.png' },
    { url: 'http://localhost:3845/assets/9035066fb9437a31310454062d1051da9a7a7abd.png', name: 'amazon.png' },
    { url: 'http://localhost:3845/assets/df4bec2a96590526c4e9e3730ac396a3cbc78077.png', name: 'rectangle-4600.png' },
  ...
  process: [
    ...
    { url: 'http://localhost:3845/assets/a664a6f17819fae9e07d3ceb1b5e119fee0094bb.svg', name: 'group-product-research.svg' }, // Product Research
    { url: 'http://localhost:3845/assets/e50ea25809e257b2a57c7b58ff808c9eda10e9ef.svg', name: 'group-listing-creation.svg' }, // Listing Creation
    { url: 'http://localhost:3845/assets/8b68b03cf6bc9454fdd5d2f946b8d10250d59a1f.svg', name: 'vector-launch-strategy.svg' }, // Launch Strategy
    { url: 'http://localhost:3845/assets/74b24828f173ed4e695ec9db3add13a93673828b.svg', name: 'vector-stroke-optimization.svg' }, // Ongoing Optimization
  ],
  logos: [
    { url: 'http://localhost:3845/assets/9035066fb9437a31310454062d1051da9a7a7abd.png', name: 'amazon-logo-main.png' },
...
async function downloadAllImages() {
  const baseDir = path.join(__dirname, '..', 'public', 'images', 'amazon');
